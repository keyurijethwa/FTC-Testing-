...
public class ShootPath extends LinearOpMode {
    ...
    private final Pose path1 = poseFactory.of(60, 40, 90);


    private final  Pose path2 = poseFactory.of(20,9,180);
    private final Pose path2Control=poseFactory.of(54,9,180);
    private final Pose path3 = poseFactory.of(60,105,270);
    private final Pose point3Control1 = poseFactory.of(11, 80, 0);
    private final Pose path4=poseFactory.of(66,20,270);


    private Intake_Balls ib;
    public Command autoRoutine() {
        return sequential(
                instant(() -> foresightConfig.maxPathSpeed.set(1.0)),
                ...
                waitMs(1000),
                instant(()-> ib.in(0.7)),
                instant(() -> foresightConfig.maxPathSpeed.set(0.7)),
    ...
    public Path path2(){
        return curve(path1,path2Control,path2).linear(path1,path2);
